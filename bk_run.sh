...
echo "----- Test case one -----"
#./threeseq test1/A.txt test1/B.txt test1/C.txt  
# max 5262 
./threeseq test2/NM_000558.txt test2/NM_008218.txt test2/NM_013096.txt
echo "----- Test case two -----"
# max 12362
./threeseq test3/NM_001030004.txt test3/NM_178850.2.txt test3/XM_514664.txt
